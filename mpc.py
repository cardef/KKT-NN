...
parameters = [
    ...
    Variable("b", 0.1, 0.3),
    Variable("r", 0.1, 2.0),
    Variable("T_0", 15.0, 25.0),
    Variable("T_ref", 21.0, 23.0),
]

decision_variables = [
    Variable(f"U_{i+1}", 0.0, 5.0) for i in range(horizon)
]
...
model = KINN(problem=problem, validation_filepath=validation_filepath, learning_rate=3e-4, early_stop_patience=5000, scheduler_patience=800)
